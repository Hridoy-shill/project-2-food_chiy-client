        ...
        <div>
            ...
            <div className='p-5'>
                <Pdf targetRef={ref} filename="code-example.pdf">
                    ...
                    <button onClick={toPdf} className='btn bg-orange-400 hover:bg-orange-400 border-none font-lg font-bold'>Generate Pdf <FaArrowDown className='ms-3'></FaArrowDown></button></div>}
                </Pdf>
